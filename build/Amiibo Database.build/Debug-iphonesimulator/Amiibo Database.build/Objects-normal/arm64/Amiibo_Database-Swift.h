...
#ifndef AMIIBO_DATABASE_SWIFT_H
#define AMIIBO_DATABASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Amiibo_Database",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Amiibo_Database11AppDelegate")
...
SWIFT_CLASS("_TtC15Amiibo_Database13SceneDelegate")
